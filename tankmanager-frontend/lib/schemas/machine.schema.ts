...
// Kopie der Backend Enums für Frontend-Validierung
...
type CounterTypeEnum = typeof CounterType[keyof typeof CounterType];
type FuelTypeEnum = typeof FuelType[keyof typeof FuelType];
type MachineStatusEnum = typeof MachineStatus[keyof typeof MachineStatus];

// Zod Schema für Machine Creation (Frontend)
