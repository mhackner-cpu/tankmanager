...
export default function Navigation() {
  ...
  return (
    ...
    >
      <Link href="/" style={{ textDecoration: "none", fontWeight: 700, fontSize: "18px", color: colors.black }}>
        🚜 TankManager
      </Link>
          ...
          {navItems.map((item) => (
            <Link
              ...
              style={{
                ...
                padding: "10px 16px",
                borderRadius: "8px",
                backgroundColor: "rgba(144, 238, 144, 0.3)", // Hellgrüner Hintergrund
      ...
      <div style={{ display: "flex", alignItems: "center", gap: "15px" }}>
        {loggedIn && user && (
          <>
            {/* Systemverwaltung Button für ADMIN & MANAGEMENT */}
